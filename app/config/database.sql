...
CREATE TABLE IF NOT EXISTS `taxi_bookings` (
  ...
  `return_status` int(10) unsigned DEFAULT NULL,
  `parent_id` int(10) unsigned DEFAULT NULL,
  `booking_type` decimal(9,2) unsigned DEFAULT NULL,
  `d_stripeLink` varchar(255) DEFAULT NULL,
  `remainingBalance` varchar(255) DEFAULT NULL,
  `rb_stripeLink` varchar(255) DEFAULT NULL,
  ...
  `c_departure_terminal` varchar(255) DEFAULT NULL,
  `cc_type` blob,
  `cc_num` blob,
  `cc_exp_month` blob,
  `cc_exp_year` blob,
...
CREATE TABLE IF NOT EXISTS `taxi_bookings_extras` (
  ...
  `extra_value` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `taxi_fleets` (
  ...
  `time_rate_per_minute` decimal(9,2) unsigned DEFAULT NULL,
...
(1, 'o_bf_include_departure_airline_company', 4, '1|2|3::2', 'No|Yes|Yes (required)', 'enum', 14, 1, NULL),
(1, 'o_bf_include_departure_flight_number', 4, '1|2|3::2', 'No|Yes|Yes (required)', 'enum', 15, 1, NULL),
(1, 'o_bf_include_departure_flight_time', 4, '1|2|3::2', 'No|Yes|Yes (required)', 'enum', 16, 1, NULL),
(1, 'o_bf_include_departure_terminal', 4, '1|2|3::2', 'No|Yes|Yes (required)', 'enum', 18, 1, NULL),
...
(1, 'o_search_result_redirect', 2, 'book-now', NULL, 'string', 17, 1, NULL);

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'opt_o_search_result_redirect', 'backend', 'Options / Search Result Page', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Search Result Page', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'opt_o_search_result_redirect_text', 'backend', 'Options / Limit your search result page', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Limit your search result page', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'front_departurec_terminal', 'frontend', 'Label / departurec_terminal / Gate', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'departurec_terminal / Gate', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblBookingTerminal', 'backend', 'Label / Display name for Dirver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Display name for Dirver', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblRemainingBalance', 'backend', 'Label / Remaining Balance', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Remaining Balance', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblStripeLink', 'backend', 'Label / Payment Link', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Payment Link', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblFeePerMints', 'backend', 'Label / Time Rate', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Time Rate', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'opt_o_allow_payonline', 'backend', 'Options / Allow payment with Pay online', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Allow Pay online payments', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'opt_o_allow_cardonboard', 'backend', 'Options / Allow payment with Card on board', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Allow Card on board payments', 'script');
...
INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'payment_methods_ARRAY_payonline', 'arrays', 'payment_methods_ARRAY_payonline', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Pay online', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'payment_methods_ARRAY_cardonboard', 'arrays', 'payment_methods_ARRAY_cardonboard', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Card on board', 'script');
...
ADD COLUMN `driver_id` INT(10) UNSIGNED DEFAULT NULL AFTER `cc_code`;

INSERT INTO `taxi_plugin_auth_roles` (`id`, `role`, `is_backend`, `is_admin`, `status`) VALUES
(4, 'Driver', 'T', 'T', 'T');
COMMIT;
...
DROP TABLE IF EXISTS `taxi_driver_files`;
CREATE TABLE IF NOT EXISTS `taxi_driver_files` (
   `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    `file_category` ENUM('license', 'id', 'photo', 'additional') DEFAULT 'additional',
    `created` datetime DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY `driver_id` (`driver_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT IGNORE INTO `taxi_notifications` (`recipient`, `transport`, `variant`, `is_active`) VALUES
('client', 'email', 'driverassingconfirmation', 1),
('drivers', 'email', 'driverconfirmation', 1),
('drivers', 'email', 'drivercancel', 1);

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_bodies_ARRAY_ADR01', 'arrays', 'error_bodies_ARRAY_ADR01', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'All the changes made to this driver have been saved.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_bodies_ARRAY_ADR03', 'arrays', 'error_bodies_ARRAY_ADR03', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'All the changes made to this driver have been saved.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_bodies_ARRAY_ADR04', 'arrays', 'error_bodies_ARRAY_ADR04', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'We are sorry, but the driver has not been added.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_bodies_ARRAY_ADR08', 'arrays', 'error_bodies_ARRAY_ADR08', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'driver your looking for is missing.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'infoUpdateDriverTitle', 'backend', 'Infobox / Update', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Update driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblDriverDetails', 'backend', 'Label / Client details', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver details', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'opt_o_email_driverassingconfirmation', 'backend', 'Options / New reservation received email', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drive assign for your booking', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'notifications_ARRAY_drivers_email_driverconfirmation', 'arrays', 'notifications_ARRAY_drivers_email_confirmation', 'script', '2022-02-14 10:33:40');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Booking confirm received email', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'notifications_ARRAY_drivers_email_drivercancel', 'arrays', 'notifications_ARRAY_drivers_email_drivercancel', 'script', '2022-02-14 10:33:40');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Booking cancled', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'notifications_ARRAY_drivers_whatsapp_confirmation', 'arrays', 'notifications_ARRAY_drivers_whatsapp_confirmation', 'script', '2022-02-14 10:33:40');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Booking Notification on whatsapp', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'notifications_ARRAY_client_email_driverassingconfirmation', 'arrays', 'notifications_ARRAY_client_email_confirmation', 'script', '2022-02-14 10:38:54');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drive assign for your booking', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'recipients_ARRAY_drivers', 'arrays', 'recipients_ARRAY_drivers', 'script', '2022-02-14 09:37:04');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_titles_ARRAY_ADR01', 'arrays', 'error_titles_ARRAY_ADR01', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver updated!', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_titles_ARRAY_ADR03', 'arrays', 'error_titles_ARRAY_ADR03', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver added!', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_titles_ARRAY_ADR04', 'arrays', 'error_titles_ARRAY_ADR04', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver failed to add.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'error_titles_ARRAY_ADR08', 'arrays', 'error_titles_ARRAY_ADR08', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Driver not found.', 'script');

INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, NULL, 'pjAdminDrivers');
SET @level_1_id := (SELECT LAST_INSERT_ID());

  INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_1_id, 'pjAdminDrivers_pjActionIndex');
  SET @level_2_id := (SELECT LAST_INSERT_ID());

    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionCreate');
    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionUpdate');
    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionDeleteDriver');
    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionDeleteDriverBulk');
    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionStatusDriver'); 
    INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminDrivers_pjActionExportDriver');

INSERT INTO `taxi_plugin_auth_permissions` (`id`, `parent_id`, `key`)
VALUES (NULL, @level_1_id, 'pjAdminDrivers_pjActionGetDriverReservationIndex');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverFullName', 'backend', 'Driver / Full Name', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Full Name', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverEmail', 'backend', 'Driver / Email', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Email', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverPhone', 'backend', 'Driver / Phone', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Phone', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverAddress', 'backend', 'Driver / Address', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Address', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverGender', 'backend', 'Driver / Gender', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Gender', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverDob', 'backend', 'Driver / Date of Birth', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Date of Birth', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverLicenseNumber', 'backend', 'Driver / License Number', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'License Number', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverLicenseExpiry', 'backend', 'Driver / License Expiry', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'License Expiry Date', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverNationalIDNumber', 'backend', 'Driver /  National ID', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'National ID', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverVehicle_id', 'backend', 'Driver /  Vehicle Number', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Vehicle Number', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverVehicleAssigned', 'backend', 'Driver / Vehicle Assigned', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Vehicle Assigned', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverPassword', 'backend', 'Driver / Password', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Password', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverLicenseFile', 'backend', 'Driver / License File', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'License Document', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverStatus', 'backend', 'Driver / Status', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Status', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'driverNotes', 'backend', 'Driver / Notes', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Notes', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'menuDrivers', 'backend', 'Menu / Drivers', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'infoDriversDesc', 'backend', 'Infobox / List of Drivers', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Below is a list of all Drivers. You can edit a specific Driver by clicking on the pencil icon in the corresponding entry.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'infoDriversTitle', 'backend', 'Infobox / List of Drivers', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'List of Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblOptionDriver', 'backend', 'Label / Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblUpdateDriver', 'backend', 'Label / Update Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Update Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers', 'backend', 'pjAdminDrivers', 'script', '2022-03-31 10:21:33');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drivers Menu', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionIndex', 'backend', 'pjAdminDrivers_pjActionIndex', 'script', '2022-03-31 10:21:45');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drivers List', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionCreate', 'backend', 'pjAdminDrivers_pjActionCreate', 'script', '2022-03-31 10:22:11');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Add Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionUpdate', 'backend', 'pjAdminDrivers_pjActionUpdate', 'script', '2022-03-31 10:22:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Update Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionDeleteDriver', 'backend', 'pjAdminDrivers_pjActionDeleteDriver', 'script', '2022-03-31 10:22:42');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Delete single Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionDeleteDriverBulk', 'backend', 'pjAdminDrivers_pjActionDeleteDriverBulk', 'script', '2022-03-31 10:23:00');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Delete multile Drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionStatusDriver', 'backend', 'pjAdminDrivers_pjActionStatusDriver', 'script', '2022-03-31 10:23:24');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Revert drivers status', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionExportDriver', 'backend', 'pjAdminDrivers_pjActionExportDriver', 'script', '2022-03-31 10:23:39');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Export drivers', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'pjAdminDrivers_pjActionGetDriverReservationIndex', 'backend', 'pjAdminDrivers_pjActionGetDriverReservationIndex', 'script', '2022-03-31 10:23:39');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Drivers Reservation', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'btnAddDriver', 'backend', 'Button / Add Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Add Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'infoAddDriverDesc', 'backend', 'Infobox / Add Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Fill in the form below and click "Save" to add a new Driver.', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'infoAddDriverTitle', 'backend', 'Infobox / Add Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Add Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'lblAddDriver', 'backend', 'Label / Add Driver', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Add Driver', 'script');

INSERT INTO `taxi_plugin_base_fields` VALUES (NULL, 'front_your_reservations', 'frontend', 'Label / Reservations', 'script', '2022-05-10 13:16:50');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `taxi_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Reservations', 'script');