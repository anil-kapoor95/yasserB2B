                        ...
                        <tbody>
...

                            {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo pjSanitize::clean($pickup_arr['phone']);?></td>
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            ...
                            <tr class="bold">
                                ...
                                <td><?php echo pjCurrency::formatPrice($pickup_arr['deposit']);?> </td>
                            ...
                            <tr class="bold">
                                ...
                                <td><?php echo pjCurrency::formatPrice($pickup_arr['remainingBalance']);?></td>
