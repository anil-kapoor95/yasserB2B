<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php __('infocategiryDesc', false, true);?></p>
    </div><!-- /.col-md-12 -->
</div>
    ...
    <div class="col-lg-8">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                	<div class="col-md-4">
                    	<a href="#" class="btn btn-primary pjFdAddExtra"><i class="fa fa-plus"></i> <?php __('btnAddCategory') ?></a>
                    </div><!-- /.col-md-6 -->
