    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" name="price" value="<?php echo pjSanitize::html($tpl['arr']['price']);?>" class="form-control text-right number required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-number="<?php __('pj_number_validation', false, true);?>">
        ...
        <div class="form-group">
            ...
            <div class="switch">
                <div class="onoffswitch onoffswitch-data">
                    <input type="checkbox" class="onoffswitch-checkbox" name="price_per_person" id="price_per_person"<?php echo $tpl['arr']['per']=='person' ? ' checked="checked"' : NULL;?>>
