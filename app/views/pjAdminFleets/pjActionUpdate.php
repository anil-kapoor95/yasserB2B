        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
               <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminFleets&amp;action=pjActionUpdate" method="post" id="frmUpdateFleet" class="pj-form form" enctype="multipart/form-data">
					...
					<input type="hidden" id="index_daterange_price_arr" name="index_daterange_price_arr" value="" />
					<input type="hidden" id="remove_daterange_price_arr" name="remove_daterange_price_arr" value="" />
                    <div class="row">
                        <div class="col-sm-6">
                        	<?php
                        	...
                        	<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="overbooking_cost" name="overbooking_cost" value="<?php echo pjSanitize::clean($tpl['arr']['overbooking_cost'])?>" class="form-control pj-field-price  number" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-number="<?php __('pj_number_validation');?>"/>
								...
								<div class="col-sm-6">
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="price_hike" name="price_hike" value="<?php echo pjSanitize::clean($tpl['arr']['price_hike'])?>" class="form-control pj-field-price number" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-number="<?php __('pj_number_validation');?>"/>
								...
								<div class="col-sm-6">
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="numberof_booking" name="numberof_booking" value="<?php echo pjSanitize::clean($tpl['arr']['numberof_booking'])?>" class="form-control pj-field-price number" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-number="<?php __('pj_number_validation');?>"/>
						...
						<div class="col-sm-8 col-xs-9">
							<div class="table-responsive abc">
								<table id="pjTbDateRangePriceTable" class="pj-table" cellpadding="0" cellspacing="0" style="width: 100%">
									...
									<tbody>
										<?php foreach ($tpl['daterange_price_arr'] as $k => $v) {  ?>
										<tr class="pjTbDateRangePriceRow" data-index="<?php echo $v['id']; ?>">
											<!-- FROM DATE -->
											<td style="padding: 0px 10px 10px 0;">
												<div class="input-group">
												<input type="text" name="from_date[<?php echo $v['id']; ?>]" value="<?php echo pjSanitize::clean($v['from_date']); ?>" class="form-control required datetimepick datetimepickdaterange" readonly data-msg-required="<?php __('tr_field_required'); ?>" />
											...
											<td style="padding: 0px 10px 10px 0;"> 
												<div class="input-group">
												<input type="text" name="to_date[<?php echo $v['id']; ?>]" value="<?php echo pjSanitize::clean($v['to_date']); ?>" class="form-control required datetimepick datetimepickdaterange" readonly data-msg-required="<?php __('tr_field_required'); ?>" />
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
												</div>
											</td>
											<!-- PRICE -->
											<td style="padding: 0px 10px 10px 0;">
												<div class="input-group">
													<input type="text" name="price_date[<?php echo $v['id']; ?>]" value="<?php echo pjSanitize::clean($v['price']); ?>" class="form-control required number"
														data-msg-required="<?php __('tr_field_required'); ?>"
														data-msg-number="<?php __('pj_number_validation'); ?>" />
											...
											<!-- DELETE -->
											<td class="text-right">
												<a href="#" class="btn btn-danger btn-outline btn-sm lnkRemoveDateRangePrice"
												data-index="<?php echo $v['id']; ?>"> <i class="fa fa-trash"></i>
												</a>
											</td>
