	...
	<div class="col-sm-12 bookings-page-heading">
		<div class="row">
			<div class="col-sm-10 list-view">
				<h2><?php __('lblReport');?></h2>
			</div>			
		</div><!-- /.row -->

		<p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoReportDesc');?></p>
	</div><!-- /.col-md-12 -->
					...
					<form action="" method="get" class="form-horizontal frm-filter">
    					<div class="row m-b-md">
    						<div class="col-lg-2 col-md-2 col-sm-12 m-b-sm">
                                <select name="supplier_id" class="form-control pj-filter-supplier">
                                    <option value="">-- <?php __('lblAllSuppliers');?> --</option>
                                    <?php if (!empty($tpl['suppliers'])) { ?>
                                        <?php foreach ($tpl['suppliers'] as $supplier) { ?>
                                            <option value="<?php echo $supplier['id']; ?>">
                                                <?php echo pjSanitize::html($supplier['name']); ?>
                                            </option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
...
<script type="text/javascript">
    ...
    myLabel.supplier_amount = <?php x__encode('plugin_base_lbl_supplier_amount', false, true); ?>;
