    ...
    <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSuppliers&amp;action=pjActionDriverUpdate" method="post" id="frmUpdateDriver" enctype="multipart/form-data">
