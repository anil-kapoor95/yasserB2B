        		...
        		<div role="tabpanel" class="tab-pane active" id="tab-booking-details">
        			...
        			<div class="panel-body">
        				...
        				<div class="row">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								...
								<div class="form-group">
									...
									<label class="control-label"><?php __('plugin_base_lbl_booking_type');?></label>

									<select name="return_status" id="return_status" class="form-control required" data-msg-required="<?php __('lblFieldRequired');?>">

										<option value="">-- <?php __('lblChoose'); ?>--</option>

										<option value="0" <?php echo ($tpl['arr']['return_status'] == '0' ? 'selected' : ''); ?>><?php __('plugin_base_lbl_one_way');?></option>

										<option value="1" <?php echo ($tpl['arr']['return_status'] == '1' ? 'selected' : ''); ?>><?php __('plugin_base_lbl_round_trip');?></option>
        				...
        				<div class="clearfix">
							...
							<button type="button" class="btn btn-white btn-lg pull-right" onclick="window.location.href='<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjAdminSuppliers&action=pjActionAvailableRides';"><?php __('btnCancel'); ?></button>
				                ...
				                <div class="col-lg-6 col-md-6 col-sm-6">
				                    ...
				                    <div class="col-lg-2 col-md-2 col-sm-2">
				                        ...
				                        <span style="padding-top: 10px;">
				                            ...
				                            <a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSuppliers&amp;action=pjActionDriverConfirmation&amp;booking_id=<?php echo $tpl['arr']['id']; ?>" data-remote="false" data-toggle="modal" data-target="#modalConfirmation" class="btn btn-primary btn-md btn-outline"><i class="fa fa-bell-o"></i> <?php __('lblResendConfirmation'); ?></a>
