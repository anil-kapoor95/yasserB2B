<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i> 
            Fill in the form below and click "Save" to add a new supplier.
        </p>
    </div><!-- /.col-md-12 -->
</div>
<?php
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjSupplier&amp;action=pjActionCreate" method="post" id="frmCreateClient">
                	<input type="hidden" name="supplier_create" value="1" />
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
								...
								<div class="input-group">
                                	...
                                	<input type="email" name="email" id="email" class="form-control email required" placeholder="info@domain.com" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                                </div>
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
								...
								<div class="input-group">
                                	...
                                	<input type="password" name="password" id="password" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                                </div>
                            </div>
                        </div><!-- /.col-md-3 -->
