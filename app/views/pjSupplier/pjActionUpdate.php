<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i> 
            You can make any changes on the form below and click "Save" button to edit supplier information.
        </p>
    </div><!-- /.col-md-12 -->
</div>
<?php
    ...
    <div class="col-lg-12">
            ...
            switch (true)
            {
                case in_array($error_code, array('AC01', 'AC03')):
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Supplier updated!</strong>
                        All the changes made to this supplier have been saved. 
                    </div>
                    <?php
                    break;
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjSupplier&amp;action=pjActionUpdate" method="post" id="frmUpdateClient">
                	<input type="hidden" name="supplier_update" value="1" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="fname" name="fname" value="<?php echo pjSanitize::html($tpl['arr']['first_name']); ?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                            </div>
                        </div><!-- /.col-md-3 -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lname" name="lname" value="<?php echo pjSanitize::html($tpl['arr']['last_name']); ?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                            </div>
                        </div><!-- /.col-md-3 -->
                    </div><!-- /.row -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
								...
								<div class="input-group">
                                	...
                                	<input type="text" name="email" value="<?php echo pjSanitize::html($tpl['arr']['email']); ?>" id="email" class="form-control email required" placeholder="info@domain.com" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                                </div>
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
								...
								<div class="input-group">
                                	...
                                	<input type="password" name="password" value="<?php echo pjSanitize::html($tpl['arr']['password']); ?>" id="password" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" maxlength="255">
                                </div>
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
								...
								<div class="input-group">
                                	...
                                	<input type="text" name="phone" id="phone" class="form-control" placeholder="(123) 456-7890" value="<?php echo pjSanitize::html($tpl['arr']['phone']); ?>" maxlength="255">
                                </div>
                            </div>
                        </div><!-- /.col-md-3 -->
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="vehicles" id="vehicles" value="" class="form-control">
                            </div>
                        </div> -->
                    ...
                    <div class="clearfix">
                        ...
                        <a class="btn btn-white btn-lg pull-right" href="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjSupplier&action=pjActionIndex"><?php __('btnCancel'); ?></a>
                    </div><!-- /.clearfix -->
                </form>
            </div>
        </div>
