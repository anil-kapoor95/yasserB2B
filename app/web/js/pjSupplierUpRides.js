...
(function ($, undefined) {
	...
	$(function () {
		...
		$(document).on("focusin", ".timepick", function (e) {
			...
			$grid.datagrid("load", "index.php?controller=pjAdminSuppliers&action=pjActionGetUpcomingBooking" + pjGrid.queryString, "created", "DESC", content.page, content.rowCount);
