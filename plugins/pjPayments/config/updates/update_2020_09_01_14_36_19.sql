...
INSERT IGNORE INTO `plugin_payment_options` (`foreign_id`, `payment_method`) VALUES (1, 'payonline');
INSERT IGNORE INTO `plugin_payment_options` (`foreign_id`, `payment_method`) VALUES (1, 'cardonboard');
...
INSERT INTO `fields` VALUES (NULL, 'plugin_payment_allow_payonline', 'backend', 'plugin_payment_allow_payonline', 'plugin', '2020-09-01 15:59:56');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Allow Pay online', 'plugin');

INSERT INTO `fields` VALUES (NULL, 'plugin_payment_allow_cardonboard', 'backend', 'plugin_payment_allow_cardonboard', 'plugin', '2020-09-01 15:59:56');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Allow Card on board', 'plugin');
