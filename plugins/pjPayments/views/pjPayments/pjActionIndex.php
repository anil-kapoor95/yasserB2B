            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    if(!empty($active_arr))
                    {
                        ...
                        <div class="row">
                            ...
                            if(pjObject::getPlugin('pjPayments') !== NULL)
                            {
                                ...
                                {  
                                    if(!in_array($payment_method, array('cash', 'bank', 'payonline', 'cardonboard')))
                                    {
                    ...
                    if(!empty($other_methods))
                    {
                        ...
                        if((array_key_exists('cash', $other_methods) && !array_key_exists('cash', $active_arr)) || (array_key_exists('bank', $other_methods) && !array_key_exists('bank', $active_arr)) || (array_key_exists('payonline', $other_methods) && !array_key_exists('payonline', $active_arr)) || (array_key_exists('cardonboard', $other_methods) && !array_key_exists('cardonboard', $active_arr)))
                        { 
                            ?>
                            <div class="m-t-lg m-b-lg">
                            ...
                            <div class="row">
                                ...
                                if(array_key_exists('payonline', $other_methods) && !array_key_exists('payonline', $active_arr))
                                {
                                    ?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                        <a href="#" class="payment paymentLink" data-method="payonline" title="<?php echo $payment_methods['payonline'];?>"><img src="<?php echo PJ_IMG_PATH?>backend/payments/cash.png" alt="<?php echo $payment_methods['payonline'];?>"></a>
                                    </div>
                                    <?php
                                }

                                if(array_key_exists('cardonboard', $other_methods) && !array_key_exists('cardonboard', $active_arr))
                                {
                                    ?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                        <a href="#" class="payment paymentLink" data-method="cardonboard" title="<?php echo $payment_methods['cardonboard'];?>"><img src="<?php echo PJ_IMG_PATH?>backend/payments/cash.png" alt="<?php echo $payment_methods['cardonboard'];?>"></a>
                                    </div>
                                    <?php
                                }
